...
public class TestUnit {
    ...
    public static void main(String[] args) {
        try {
            DbSearcher _searcher = new DbSearcher(new DbConfig(), "C:\\Users\\Song\\Downloads\\ip2region-1.9.0-release\\ip2region-1.9.0-release\\data\\ip2region.db");
            BufferedReader bfr   = new BufferedReader(new FileReader("C:\\Users\\Song\\Downloads\\ip2region-1.9.0-release\\ip2region-1.9.0-release\\data\\ip.merge.txt"));
            BufferedWriter bwr   = new BufferedWriter(new FileWriter("C:\\Users\\Song\\Downloads\\ip2region-1.9.0-release\\ip2region-1.9.0-release\\data\\error_log.txt", true));
            int errCount  = 0;
            int lineCount = 0;
            String str = null;
