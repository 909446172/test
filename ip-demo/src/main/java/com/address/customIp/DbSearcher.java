...
import com.address.customIp.resource.IndexBlock;
...
public class DbSearcher 
{
    ...
    */
     ...
     * @throws  IOException
    */
    public DataBlock memorySearch(long ip ,byte[] b) throws IOException
    {
        int blen = IndexBlock.getIndexBlockLength();
        if ( dbBinStr == null ) {
            dbBinStr = b;
            long  l = dbBinStr.length;
            raf.seek(0L);
    ...
    public DataBlock customSearch( String ip ) throws IOException
    {
        return customSearch(Util.ip2long(ip));
    }


    public DataBlock customSearch(long ip) throws IOException
    {


        //check and load the header
        if ( HeaderSip == null )  {
            raf.seek(0L);    //pass the super block
        ...
        System.out.println(new String(data, 4, data.length-4 , "UTF-8"));
     ...
     * @throws  IOException 
    */
    public DataBlock memorySearch( String ip ,byte[] b) throws IOException
    {
        return memorySearch(Util.ip2long(ip),b);
    }
